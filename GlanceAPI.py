...
# copied from https://github.com/pvo/logster/blob/master/parsers/GlanceAPI.py
...
class GlanceAPI(LogsterParser):
    ...
    def __init__(self, option_string=None):
        ...
        #2013-08-16 09:45:14.608 2272 INFO nova.osapi_compute.wsgi.server [-] 192.168.0.20 "OPTIONS / HTTP/1.0" status: 200 len: 282 time: 0.0005710
        self.reg = re.compile('.*HTTP/1.\d\" status: (?P<http_status_code>\d{3}) .*')

...
* [r14.2.0](https://github.com/rcbops/rpc-openstack/tree/r14.2.0): The second RPCO release of OpenStack Newton. This version includes Leapfrog upgrade tools.
...
popd
git fetch origin
git checkout r14.2.0
git submodule update
git status
```

It is crucial that the rpco repo and openstack-ansible submodule are both clean
and at the appropriate SHAs for r14.2.0 at this stage. The [github
r14.2.0 tag
page](https://github.com/rcbops/rpc-openstack/tree/r14.2.0) shows both SHAs,
